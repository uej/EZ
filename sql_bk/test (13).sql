...
--
-- Host: 127.0.0.1
-- Generation Time: 2018-12-07 09:51:02
-- 服务器版本： 5.5.47
-- PHP Version: 7.0.1
...
INSERT INTO `cmf_manage_company` (`id`, `name`, `address`, `contact`, `phone`, `parentId`, `createTime`, `createUserId`, `modifyUserId`, `status`, `typeId`) VALUES
