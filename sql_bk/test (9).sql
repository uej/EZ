...
--
-- Host: 127.0.0.1
-- Generation Time: 2018-09-19 12:04:47
-- 服务器版本： 5.5.47
-- PHP Version: 7.0.1
...
(9, 2, 3, 1, '编辑', 'manage', 'apps', 'editMenu', 1536486282, 1, 'layui-btn layui-btn-xs', 1, 0, 2, '', ''),
(10, 4, 0, 1, '根据appid获取菜单列表', 'manage', 'apps', 'getMenuByAppId', 1536486545, 0, '', 1, 0, 0, '', ''),
(11, 2, 1, 1, '删除', 'manage', 'Apps', 'delApp', 1536992043, 2, 'layui-btn layui-btn-xs layui-btn-danger', 1, 1, 3, '', ''),
