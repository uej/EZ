...
--
-- Host: 127.0.0.1
-- Generation Time: 2018-08-28 11:01:54
-- 服务器版本： 5.5.47
-- PHP Version: 7.0.1
...
(1, 'manage', '后台管理', '应用后台管理，用户管理，商户管理等', 0, '', 'manage/apps/index', 'fa-gears', 1, 1, 'red');
...
INSERT INTO `cmf_common_menu` (`id`, `typeId`, `parentId`, `appId`, `title`, `app`, `controller`, `action`, `createTime`, `sort`, `className`, `status`, `askSure`) VALUES
(1, 1, 0, 1, '应用管理', 'manage', 'apps', 'index', 0, 1, NULL, 1, 0),
(2, 1, 0, 1, '商户管理', 'manage', 'company', 'index', 0, 3, NULL, 1, 0),
(3, 1, 0, 1, '功能菜单', 'manage', 'apps', 'menu', 0, 2, NULL, 1, 0),
(4, 1, 0, 1, '用户管理', 'manage', 'company', 'user', 0, 4, NULL, 1, 0),
(5, 1, 0, 1, '角色管理', 'manage', 'company', 'role', 0, 5, NULL, 1, 0);
