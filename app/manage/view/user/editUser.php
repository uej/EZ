    ...
    <div class="layui-form" style="margin-top: 20px;">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="text" autocomplete="off" name="account" class="layui-input" value="<?=$data['account']?>" lay-verify="required" style="width: 300px;">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="width: 300px;">
                <select name="companyId" id="companyId" lay-filter="companyId" lay-verify="required">
                    ...
                    <option value="<?=$val['id']?>" <?php if($val['id'] == $data['companyId']) echo 'selected'; ?>><?=$val['name']?></option>
                    <?php } ?>
                </select>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="width: 300px;">
                <select name="roleId" id="roleId" lay-verify="required">
                    ...
                    <?php foreach ($nowrole as $val) { ?>
                    <option value="<?=$val['id']?>" <?php if($val['id'] == $data['roleId']) echo 'selected'; ?>><?=$val['name']?></option>
                    <?php } ?>
                </select>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" autocomplete="off" name="phone" value="<?=$data['phone']?>" class="layui-input" style="width: 300px;">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">状态</label>
            <div class="layui-input-block">
                <input type="radio" name="status" value="1" title="正常" <?php if($data['status'] == 1) echo 'checked'; ?>>
                <input type="radio" name="status" value="0" title="封禁" <?php if($data['status'] == 0) echo 'checked'; ?>>
            </div>
        </div>
